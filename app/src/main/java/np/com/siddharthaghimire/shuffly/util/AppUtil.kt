...
object AppUtil {
    ...
    fun isConnection(): Boolean {
        val connectivityManager = ShufflyApp.INSTANCE
    ...
    inline fun Context.cameraPermissionRequest(crossinline positive: () -> Unit) {
        AlertDialog.Builder(this)
            ...
            .setMessage("Without accessing the camera it is not possible to Detect People")
    ...
    fun getCurrentRegionCode(context: Context): String {
        ...
        Log.d("TIGER", "getCurrentRegionCode: networkCountry: "+telephonyManager.networkCountryIso)
